...
$herencias = $_POST['herencias'];
$alergias = $_POST['alergias'];
$grupoSanguineo = $_POST['grupoSanguineo'];

$cirugias = $_POST['cirugias'];
$medicamentosSup = $_POST['medicamentosSup'];
...
if (isset($_POST['ultimoPapanicolao'])) {
    $ultimoPapanicolao = $_POST['ultimoPapanicolao'];
} else {
    $ultimoPapanicolao = "";
}
if (isset($_POST['sexualidad'])) {
...
if (isset($_POST['fumtipo'])) {
    $fumtipo = $_POST['fumtipo'];
} else {
    $fumtipo = "";
}
...
$depoaficion = $_POST['depoaficion'];
$metas = $_POST['metas'];
$objetivos = $_POST['objetivos'];
$alimentosFav = $_POST['alimentosFav'];
$alimentosNoAgradables = $_POST['alimentosNoAgradables'];
$agua = $_POST['agua'];
$aguaSaborizada = $_POST['aguaSaborizada'];
...
$dh_desayuno_txt = $_POST['dh_desayuno_txt'];
$dh_colacion1_hr = $_POST['dh_colacion1_hr'];
$dh_colacion1_txt = $_POST['dh_colacion1_txt'];
$dh_comida_hr = $_POST['dh_comida_hr'];
$dh_comida_txt = $_POST['dh_comida_txt'];
$dh_colacion2_hr = $_POST['dh_colacion2_hr'];
$dh_colacion2_txt = $_POST['dh_colacion2_txt'];
$dh_cena_hr = $_POST['dh_cena_hr'];
$dh_cena_txt = $_POST['dh_cena_txt'];
$despierta = $_POST['despierta'];
$duerme = $_POST['duerme'];
$finDeSemana = $_POST['finDeSemana'];
